      ...
      >
        <View style={styles.logoContainer}>
          <Image
            ...
            contentFit="contain"
          />
          <Typography.Body style={styles.tagline}>
            Divide gastos, multiplica amigos.
          </Typography.Body>
        </View>

        <View style={styles.formContainer}>
          <View style={styles.form}>
            <Typography.SubHeader style={styles.title}>
              Login
            ...
            <TouchableOpacity style={styles.forgotPassword} disabled={isBusy}>
              <Typography.Body style={styles.forgotText}>
                Forgot password?
              </Typography.Body>
            </TouchableOpacity>
            ...
            <View style={styles.footer}>
              <Typography.Body style={styles.footerText}>
              ...
              <TouchableOpacity
                ...
                disabled={isBusy}
              >
                <Typography.Body style={styles.linkText}>
                  Register
                </Typography.Body>
              </TouchableOpacity>
            </View>
