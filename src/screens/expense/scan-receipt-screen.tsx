...
const getAudioUploadMetadata = (uri: string) => {
  ...
  return {
    ...
    mimeType: fileExtension
      ? AUDIO_MIME_TYPES[fileExtension] || "application/octet-stream"
...
export default function ScanReceiptScreen() {
  ...
  const parsedParticipantIds: string[] = participantIds
  ...
  const stopRecording = async () => {
    try {
      ...
      Alert.alert(
        "Transcription Error",
        err?.message ?? "Could not transcribe your audio.",
      );
    } finally {
      setLoading(false);
      setLoadingStep("");
      ...
      >
        ...
        >
            ...
            {imageUri ? (
              <View style={styles.readyState}>
                ...
                <View style={styles.readyBadge}>
                  ...
                  <Typography.Body style={styles.readyTitle}>
                    Receipt ready
                  </Typography.Body>
                </View>
                <View style={styles.readyActions}>
                  ...
                  >
                    ...
                    <Typography.Caption style={styles.removeActionText}>
                      Remove
                    </Typography.Caption>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={styles.readyActionBtn}
                    onPress={openReceiptSourcePicker}
                    disabled={isBusy}
                  >
                    <RefreshCw size={16} color={Colors.secondary} />
                    <Typography.Caption style={styles.uploadAgainText}>
                      Upload again
                    </Typography.Caption>
                  </TouchableOpacity>
                </View>
          ...
          <View style={styles.tipsRow}>
            ...
            <Typography.Caption style={styles.tipsText}>
              Specify names, percentages, or items
            </Typography.Caption>
          </View>
        </ScrollView>
        ...
        {!loading && (
          <View style={styles.footer}>
            <Button
              ...
              style={[
                styles.analyzeBtn,
                (!imageUri || !instruction.trim()) && { opacity: 0.5 },
              ]}
            />
          </View>
        )}
