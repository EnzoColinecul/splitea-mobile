  ...
  const handleNext = () => {
    if (activeTab === "groups") {
      ...
      if (selectedFriends.length === 0) {
        Alert.alert(
          "Select friends",
          "Please choose at least one friend to split with.",
        );
        return;
      }

      const selectedInList = friends.filter((f) =>
                      ...
                      return (
                        <View key={group.group_id}>
                          <TouchableOpacity
                            ...
                            onPress={() =>
                              setSelectedGroup(
                                isSelected ? null : group.group_id,
                              )
                            }
                          >
                            <View
              ...
              (!searchQuery ||
                ...
                <View style={styles.sectionCard}>
                  <TouchableOpacity
                    style={[
                      styles.itemRow,
                      selectedFriends.includes(currentUser.user_id) &&
                        styles.itemRowSelected,
                    ]}
                    onPress={() => toggleFriend(currentUser.user_id)}
                  >
                    <View
                      style={[styles.avatar, { backgroundColor: "#FEE2E2" }]}
                    >
                      <Text style={[styles.avatarText, { color: "#B91C1C" }]}>
...
const styles = StyleSheet.create({
  ...
  itemRowSelected: {
    ...
    borderRadius: BorderRadius.card - Spacing.xs,
  },
